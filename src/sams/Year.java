...
public class Year extends javax.swing.JFrame {
     ...
     */
    public Year(String sem, String name, String sec) {
        this.sem = sem;
        this.name = name;
        this.sec = sec;
        initComponents();
        try {
            ...
            while (rs.next()) {
                this.years.add(rs.getString("year"));
            } 
            for (int i = 0; i < years.size(); i++){
                jComboBox1.addItem(years.get(i));
            }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            setVisible(false);
            new CourseSelect(this.sem,this.name,this.sec,y).setVisible(true);
        }
